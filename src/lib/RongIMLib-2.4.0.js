...
(function (RongIMLib) {
    var RongIMClient = (function () {
        ...
        */
        ...
        RongIMClient.prototype.RTCPing = function (room) {
            RongIMLib.CheckParam.getInstance().check(["object"], "RTCPing", false, arguments);
...
(function (RongIMLib) {
    var ServerDataProvider = (function () {
        ...
        */
        ...
        ServerDataProvider.prototype.RTCPing = function (room) {
            var modules = new RongIMLib.RongIMClient.Protobuf.RtcInput();
            RongIMLib.RongIMClient.bridge.queryMsg("rtcPing", RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), room.id, {
                onSuccess: function () {
                },
                onError: function () {
                }
...
(function (RongIMLib) {
    var VCDataProvider = (function () {
        ...
        VCDataProvider.prototype.RTCPing = function (room) {
        };
