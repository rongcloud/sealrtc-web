(function (dependencies) {
  ...
  */
  ...
  var StreamBox = (function () {
    ...
    function showStream(stream) {
      ...
      if (videoDom && stream) {
        ...
        console.timeEnd('get self media')
  ...
  function showUserId(userId) {
    var userIdElement = Dom.getById('rongUserId');
    var content = utils.tplEngine('{prefix}{userId}{suffix}', {
      prefix: '(',
      suffix: ')',
      userId: userId
    })
    userId && (userIdElement.innerText = content);
  }
